...
echo -e "   My GitHub:$BOLD_WHITE https://github.com/DNQA"
exit
}
...
echo "   ║═╬╗  ║ ║  ╚╦╝  ║║║  ╠═╣  ╠═╣  ║║║  ╠═╣ "
echo "   ╚═╝╚  ╚═╝   ╩   ╝╚╝  ╩ ╩  ╩ ╩  ╝╚╝  ╩ ╩ "
echo -e "$BOLD_WHITE                            By Do Nguyen Quynh Anh  "
echo " "
}
...
echo " "
echo -e "$BOLD_BLUE  1.$BOLD_WHITE Use the default word list (1111 SSIDs)"
